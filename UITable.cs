...
public class UITable : UIWidgetContainer
{
	...
	public delegate void OnRepositionFinish(UITable table);
	...
	public UITable.OnRepositionFinish onRepositionFinish;
	...
	protected void RepositionVariableSize(List<Transform> children)
	{
		...
		while (j < count2)
		{
			...
			if (this.direction != UITable.Direction.Custom)
			{
