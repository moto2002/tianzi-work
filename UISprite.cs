...
public class UISprite : UIWidget
{
	...
	public static UISprite.CallLoadAsset monLoadAsset = null;
	...
	public static void SetLoadAssetCall(UISprite.CallLoadAsset call)
	{
		UISprite.monLoadAsset = call;
	}

	public override bool CheckWaitLoadingAtlas()
	{
		return this.atlas != null && this.atlas.spriteMaterial == null;
	}
	...
	{
		if (this.atlas != null && this.atlas.spriteMaterial == null)
		{
			...
			this.moGo = oGo;
			this.margs = args;
			this.LoadAtlas(this.atlas.name);
			return true;
		}
		return false;
	}
	...
	private void LoadAtlas(string strAtlasName)
	{
		if (Application.isPlaying)
		{
			...
			if (UISprite.monLoadAsset != null)
			{
				UISprite.monLoadAsset(text, new AssetCallBack(this.OnFileLoaded));
			}
			else
			{
	...
	private void OnFileLoaded(params object[] args)
	{
		...
		if (this.atlas != null)
		{
			this.atlas.spriteMaterial = atlasAsset.material;
			this.atlas.MarkAsChanged();
		}
		if (this.monLoaded != null)
		{
			this.monLoaded(this.mspList, this.monAllLoaded, this.moGo, this.margs);
