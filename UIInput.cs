...
public class UIInput : MonoBehaviour
{
	...
	public Action CustomOnSelectEvent;

	public Action CustomOnDeselectEvent;
	...
	protected void Init()
	{
		if (this.mDoInit && this.label != null)
		{
			...
			this.label.supportEncoding = this.mEncoding;
	...
	protected virtual void OnSelect(bool isSelected)
	{
		...
		{
			this.OnSelectEvent();
			if (this.CustomOnSelectEvent != null)
			{
				this.CustomOnSelectEvent();
			}
		}
		else
		{
			this.OnDeselectEvent();
			if (this.CustomOnDeselectEvent != null)
			{
				this.CustomOnDeselectEvent();
			}
		}
	}
