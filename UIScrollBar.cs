...
public class UIScrollBar : UISlider
{
	...
	protected override void OnStart()
	{
		...
		if (this.mFG != null && this.mFG.collider != null && this.mFG.gameObject != base.gameObject)
		{
			...
			UIEventListener expr_5A = uIEventListener;
			expr_5A.onPress = (UIEventListener.BoolDelegate)Delegate.Combine(expr_5A.onPress, new UIEventListener.BoolDelegate(base.OnPressForeground));
			UIEventListener expr_7C = uIEventListener;
			expr_7C.onDrag = (UIEventListener.VectorDelegate)Delegate.Combine(expr_7C.onDrag, new UIEventListener.VectorDelegate(base.OnDragForeground));
